...
import sellerlogin from "./sellerlogin.png";
import selllogin from "./selllogin.png";
import dashboard_icon from "./dashboard_icon.svg";
import worker_list_icon from "./worker_list_icon.svg";
import vendor_list_icon from "./vendor_list_icon.svg";
import driver_list_icon from "./driver_list_icon.svg";
import manage_people from "./manage_people.svg";
...
export const features = [
  {
    ...
    title: "Slotted Delivery",
    description: "Groceries delivered in desired time slot",
  },
  {
    icon: leaf_icon,
...
export const dummyProducts = [
  ...
  },
  {
    ...
    price: 58,
    offerPrice: 54,
    image: [tomato_image,tomato_image_2],
    description: [
      "Juicy and ripe",
      "Rich in Vitamin C",
  ...
  },
  {
    ...
    price: 78,
    offerPrice: 73,
    image: [pepsi_image,pepsi_image_2],
    description: [
